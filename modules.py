...
class Backbone2D(BackboneBase):
    ...
    def __init__(self, name,return_interm_layers,dilation=False):
        ...
        super(Backbone2D,self).__init__(backbone, return_interm_layers)



class BatchNorm2d_stats(nn.BatchNorm2d):
    # BatchNorm that returns the sample mean and variance during training
...
def create_encoders_3d(in_channels, f_maps, basic_module, conv_kernel_size, conv_padding, layer_order, num_groups,
                    pool_kernel_size):
...
def create_decoders_3d(f_maps, basic_module, conv_kernel_size, conv_padding, layer_order, num_groups, upsample):
